...
VALUES
	...
	(1027,'2017-02-13 12:00:00','C-FSKI','YXS','YVR'),
...
VALUES
	(1024,'ECONOMY',1024,1029, 1029),
  	...
  	(1026,'FIRST',1024,1031, 1031),
  	(1027,'ECONOMY',1025,1031, 1031),
  	(1028,'ECONOMY',1026,1031, 1031),
  	(1029,'ECONOMY',1027,1031, 1031),
  	(1030, 'FIRST', 1028, 1031, 1031),
  	(1031, 'FIRST', 1024, 1033, 1027),
  	(1032, 'FIRST', 1025, 1033, 1027),
  	(1033, 'ECONOMY', 1026, 1033, 1027),
  	(1034, 'BUSINESS', 1027, 1033, 1027),
  	(1035, 'FIRST', 1028, 1033, 1027),
  	(1036, 'FIRST', 1029, 1033, 1027);
